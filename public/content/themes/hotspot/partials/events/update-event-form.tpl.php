...
<?php wp_nonce_field('updateForm', 'updateEvent'); ?>
    <div class="row">
        <div class="col-12">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input class="form-control" name="updateEvent[name]" id="name" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nom de votre Event'" placeholder='Nom de votre Event' value="">
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form_group">
                <label for="datepicker_1">Choisissez la date de votre Event :</label>
                <input id="datepicker_1" name="updateEvent[date]" placeholder="Choisir une date">
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <textarea class="form-control w-100" name="updateEvent[description]" id="description" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Description de votre Event'" placeholder='Description de votre Event'></textarea>
            </div>
        </div>
        <div class="col-sm-12"></div>
