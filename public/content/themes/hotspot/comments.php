...
<div id="comments" class="comments-area default-max-width <?php echo get_option( 'show_avatars' ) ? 'show-avatars' : ''; ?>">
	...
	if ( have_comments() ) :
		...
		the_comments_pagination(
			array(
				'before_page_number' => esc_html__( 'Page', 'hotspot' ) . ' ',
				'mid_size'           => 0,
				'prev_text'          => sprintf(
					'%s <span class="nav-prev-text">%s</span>',
					is_rtl() ?  esc_html__('<i class="fas fa-arrow-left"></i>')    :  esc_html__('<i class="fas fa-arrow-right"></i>'),
	...
	comment_form(
		array(
			'logged_in_as'       => null,
			'title_reply'        => esc_html__( 'Leave a comment', 'hotspot' ),
